	...
	<table style="width: 100%" cellspacing="0" cellpadding="0" border="0.2"  >
		...
		<br>
			...
			<div style="text-align: center;" class="foot">
				<p> ¡¡¡ GRACIAS POR SU COMPRA VUELVA PRONTO !!! <br><br>
				            	...
				            	Representación impresa de la FACTURA ELECTRONICA emitida del sistema del contribuyente autorizado con fecha 02/01/2021</p><br>	    
	            </div>
