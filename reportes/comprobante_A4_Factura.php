		...
		<tr>
			...
			<table  class="articulo" border="0.1" cellpadding="0" cellspacing="1" bordercolor="black" style="border-collapse:collapse;">
				<?php 
							...
							?>
				<tr   >        
				<td style="width:9.8%; height:6px; padding-top: 6px; text-align: center;">
						<?php echo $regd->codigo;  ?>            		
					</td>                
					<td  style="width:55%; height:6px; padding-top: 6px; padding-left: 5px;  text-align: justify;">
						<?php echo $regd->articulo." ".$regd->serie ; ?>            		
					</td>
					<td style="width:10%; height:6px; padding-top: 6px; text-align: center;">
...
<div class="total">
	...
	<table cellspacing="0" cellpadding="0" border="0.2"  >
		<tr style="width: 100%; text-align: center">
			...
			<td style="text-align: center; width:12%">IGV (<?php echo $regc->igv_asig; ?>%)</td>
