...
if($_SESSION['almacen']==1)
{
  ...
  //Instaciamos la calse para gener el documento PDF
  $pdf=new PDF_MC_Table();

  //Agregamos la primera paginal documento pdf
  $pdf->AddPage();
  ...
  //Comenzamos a crear las filas del registro segun la cionsulta mysql
  require_once "../modelos/Articulo.php";
  $articulo=new Articulo();

  $rspta=$articulo->listar();

  //Implementamos las celdas de tabla con los registros a mostrar
