...
<div class="header">
	<table style="width: 100%"  >
		<tr>
		    <th style="width: 12%; text-align: center; height: 12px; ">
		    ...
		    <th style="width: 45%; text-align: center;">
		    	<table  style="width: 100%;">
		    		<tr style="text-align: center;"><th  style="width: 100%;" lass="rubro"> FERRETERIA</th></tr>
		    		<tr style="text-align: center;"><th  style="width: 100%;" class="nombre"> LOS JAZMINES</th></tr>
				    <tr style="text-align: center;"><th  style="width: 100%;" class="razon-social">DE: <?php echo $razon_social; ?></th></tr>	
				    <tr style="text-align: center;"><th  style="width: 100%;" class="info">
				    	Venta de Artículos eléctricos, Gasfitería Pernos, <br>
				    	Limpieza y Ferretería el General
				    </th></tr>				    	    		
		    	</table>  
		    </th>
		    <th style="width: 38%; text-align: center; padding-top: 5px "  class="factura">
		    	<p>R.U.C. <?php echo $rucp; ?>000000<br><br>
...
<div class="articulos">
	        ...
	        <table style="width: 100%;" class="info" >
	        	<tr>
		            <td  style="width: 30%">Telef.: <?php echo $telefono; ?></td>
		            <td  style="width: 30%">Email.: <?php echo $email; ?></td>
	        	</tr>
		 	</table>
		</div>
		<br>		
...
<!--  Cliente-->
 	<div class="cliente">
	   	<table style="width: 100%"  class="cuadro-cliente">
	   		<tr><td style="width: 13%"><b>CLIENTE</b></td><td style="width: 83%">: <?php echo $cliente; ?></td></tr>
	   		<tr><td style="width: 13%"><b>R.U.C.</b></td><td style="width: 83%">: <?php echo $ruc; ?> </td></tr>
	   		<tr><td style="width: 13%"><b>DIRECCIÓN</b></td><td style="width: 83%">: <?php echo $direccioncliente; ?> </td></tr>
	   		<tr>
	   			<td style="width: 13%"><b>FECHA</b></td>
	   			<td style="width: 83%">: <?php echo strftime("%d de %B del %Y", strtotime($fecha)); ?> 
	   				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Moneda</b>
	   				&nbsp;&nbsp;&nbsp;: <?php echo $moneda; ?> 
	   			</td>
	   		</tr>
...
<div class="articulos">
	<table style="width: 100%" class="cabecera">
	...
	<table  style="width: 100%" class="cuadro-articulo" border="0.1" cellpadding="0" cellspacing="1" bordercolor="#087DA2" style="border-collapse:collapse;border-color:#ddd;">
        <?php 
                    $cantidad=0;
					...
					<table cellspacing="0" cellpadding="0" border="0.2"  >
						<tr class="articulos" style="width: 100%; text-align: center">
				            <td style="width: 94%; padding-top: 5px">
				            	...
				            	Emitida del sistema del contribuyente autorizado con fecha 02/01/2021<br>	
				            	Puede consultar su comprobante electrónico en: Puede consultar su comprobante electrónico en: 
				            	http://www.solucionesintegralesjb.com/sistemas/consulta/           
				            </td>		            	
