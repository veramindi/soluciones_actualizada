...
<?php 
 ...
 ?>
			 ...
			 <table style="width: 100%;">
	        	...
	        	<tr>
	        		...
	        		<?php 
					 ...
					 ?>
					<td>Fecha de emisión <?php echo $dia.'-'.$mes.'-'.$anno; ?></td>
					<td></td>
	        		<td></td>
	        		<td></td>
	        	</tr>
		...
		<div class="linea">
			<div><p><b>DOCUMENTO QUE MODIFICA:</b></p></div>
			<hr>
		</div>
		...
		<div class="cliente">
			<table style="width: 100%;">
				<tr>
					...
					<td style="width: 35%"><?php echo $serie_rela.'-'.$correlativo_rela; ?></td>
					<td >Tipo nota crédito: </td>
		...
		<div class="articulos">
			<table border="" style="width: 100%;">
        		...
        		<?php while($regd=$rsptad->fetch_object()){	
        			...
        			if($regd->correccion_descripcion!=null){
        				$correccion=$regd->correccion_descripcion;
        			}else{
        				$correccion=$regd->articulo;
...
<!-- style="height: 50px; " -->
					...
					<td style="text-align:left;" class="<?php echo $estilo; ?>" ><?php echo $correccion; ?></td>
