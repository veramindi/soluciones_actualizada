 ...
 ?>
		...
		<div class="articulos">
				...
				<tr  >
					...
					<td style="text-align: left; width: 10%"><?php echo $newValorU; ?></td>
			...
			<table >
				<tr>
					...
					<td style="text-align: left; width: 5%"></td>
					<td style="text-align: right; width: 13%"><?php echo $op_gravadas; ?></td>
				</tr>
			</table>
			<table >
				<tr>
					...
					<td style="text-align: right; width: 13%"><?php echo round($sumigv,2); ?></td>
				</tr>
			</table>
			<table >
				<tr>
					...
					<td style="text-align: left; width: 75%"> </td>
					<td style="text-align: left; width: 5%"></td>
					<td style="text-align: right; width: 13%"><?php echo $total_venta; ?></td>
				</tr>
			</table>
