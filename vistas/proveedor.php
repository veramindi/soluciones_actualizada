                     ...
                     <div class="panel-body" style="height: 400px;" id="formularioregistros">
                      ...
                      <form name="formulario" method="POST" id="formulario">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select class="form-control select-picker" name="tipo_documento" id="tipo_documento" onchange="modificarInput()" required>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <label>Numero </label>
                          <input type="text" class="form-control" name="num_documento" id="num_documento" maxlength="8" placeholder="Numero">
                          <script>function modificarInput(){
                              document.getElementById("num_documento").value="";
                              switch (document.getElementById("tipo_documento").value) {
                                case "DNI":
                                  document.getElementById("num_documento").setAttribute("maxLength","8");
                                  break;
                                case "RUC":
                                  document.getElementById("num_documento").setAttribute("maxLength","11"); 
                                  break;
                              }
