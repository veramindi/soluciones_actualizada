...
function listar(){
	...
	tabla=$("#tbllistado").dataTable(
		{
			 "aProcessing": true, //Activamos el procesamiento de datatables
      		...
      		"ajax":{
      			url:"../ajax/consultas_contable.php?op=ventasFechaUsuarioR",
	...
	$.post("../ajax/consultas_contable.php?op=sumVentasFechaUsuarioRC",{fecha_inicio:fecha_inicio,fecha_fin:fecha_fin,hora_inicio:hora_inicio,hora_fin:hora_fin,idusuario:idusuario,codigotipo_pago:codigotipo_pago,codigotipo_comprobante:codigotipo_comprobante},function(data,status){
