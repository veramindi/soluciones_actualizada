...
function listar(){
	...
	tabla=$("#tbllistado").dataTable(
		{
			 "aProcessing": true, //Activamos el procesamiento de datatables
      		...
      		"ajax":{
      			url:"../ajax/consultas2.php?op=ventasFechaUsuario",
	...
	$.post("../ajax/consultas2.php?op=sumVentasFechaUsuario",{fecha_inicio:fecha_inicio,fecha_fin:fecha_fin,idusuario:idusuario},function(data,status){
