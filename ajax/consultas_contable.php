...
switch ($_GET["op"]) 
{
    ...
    case 'ventasFechaUsuarioR':
      ...
      $codigotipo_comprobante=$_REQUEST['codigotipo_comprobante'];
      $codigotipo_pago=$_REQUEST['codigotipo_pago'];
      $rspta=$consulta->ventasfechausuarioR($fecha_inicio,$fecha_fin,$hora_inicio,$hora_fin,$idusuario,$codigotipo_comprobante,$codigotipo_pago);
      $data=Array();
      while ($reg=$rspta->fetch_object()) {
        $data[]=array(
            "0"=>$reg->fecha,
    ...
    case 'sumVentasFechaUsuario':
     ...
     case 'sumVentasFechaUsuarioRC':
      ...
      $codigotipo_comprobante=$_REQUEST['codigotipo_comprobante'];
      $codigotipo_pago=$_REQUEST['codigotipo_pago'];
      $rspta=$consulta->sumventasfechausuarioRC($fecha_inicio,$fecha_fin,$hora_inicio,$hora_fin,$idusuario, $codigotipo_comprobante,$codigotipo_pago);
      echo json_encode($rspta);
    break;
