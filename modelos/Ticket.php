...
Class ticket
{
	...
	public function insertar($idcliente,$idusuario,$codigotipo_comprobante,$fecha_hora,$impuesto,$op_gravadas,$op_inafectas,$op_exoneradas,$op_gratuitas,$isc,$total_descuentos,$total_igv,$total_venta,$leyenda,$idmoneda,$idarticulo,$cantidad,$precio_venta,$descuento,$serieArticulo,$igv_asig){
    ...
    $saber = "SELECT serie,correlativo FROM venta WHERE codigotipo_comprobante='12'";
     ...
     $fecha_todo = date('Y-m-d H:i:s');
		...
		$sql="INSERT INTO venta (idcliente,idusuario,codigotipo_comprobante,serie,correlativo,fecha_hora,impuesto,op_gravadas,op_inafectas,op_exoneradas,op_gratuitas,isc,total_descuentos,total_igv,total_venta,leyenda,estado,idmoneda,idmotivo_doc,codigotipo_pago,igv_asig) VALUES ('$idcliente','$idusuario','$codigotipo_comprobante','$serie','$correlativo','$fecha_todo','$impuesto','$op_gravadas','$op_inafectas','$op_exoneradas','$op_gratuitas','$isc','$total_descuentos','$total_igv','$total_venta','$leyenda','Aceptado','$idmoneda',null,1,'$igv_asig')";
