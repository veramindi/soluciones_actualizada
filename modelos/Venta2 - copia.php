...
Class Venta2
{
    ...
    =============================================*/
      ...
      $sqlCabeceraPrincipal = "SELECT v.idventa,DATE(v.fecha_hora) as fecha, DATE_FORMAT(v.fecha_hora,\"%H:%I:%S\" ) as hora ,v.idcliente,p.nombre as clienteRazonSocial,p.direccion,p.tipo_documento,p.num_documento,v.idusuario,u.nombre
       as usuario,v.codigotipo_comprobante,v.serie,v.fecha_ven,v.correlativo,date(v.fecha_hora) as fecha,v.impuesto,v.op_gravadas,v.op_inafectas,v.op_exoneradas,v.op_gratuitas,v.isc,v.total_descuentos,v.total_igv,v.total_venta,v.leyenda,v.idmoneda,m.codigo 
